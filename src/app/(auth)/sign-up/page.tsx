            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="johndoe" {...field} icon={<Mail size={16} color="#626262"/>} className="dark:bg-[#121212] dark:border-[#1B1B1B]   dark:placeholder-[#626262] shadow-inner dark:shadow-[inset_0_2px_2px_rgba(0,0,0,0.6)]" onChange={(e)=> {
                      field.onChange(e)
                      debouncedUsername(e.target.value)
                    }} />
                  </FormControl>
                  {isChekingUsername && <Loader2 className="h-4 w-4 animate-spin" />}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="lGkKX@example.com" icon={<User size={16} color="#626262"/>} className="dark:bg-[#121212] dark:border-[#1B1B1B]   dark:placeholder-[#626262] shadow-inner dark:shadow-[inset_0_2px_2px_rgba(0,0,0,0.6)]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="password" placeholder="••••••••" icon={<Lock size={16} color="#626262"/>} className="mb-4 dark:bg-[#121212] dark:border-[#1B1B1B]   dark:placeholder-[#626262] shadow-inner dark:shadow-[inset_0_2px_2px_rgba(0,0,0,0.6)]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
